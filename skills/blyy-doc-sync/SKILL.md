...
本 Skill 的确定性清点命令矩阵、技术栈锚点矩阵均引用 `blyy-init-docs/resources/tech-stack-matrix.md`；TODO `priority`/`type`/`owner` 枚举定义引用 `blyy-init-docs/resources/front-matter-spec.md` 七.4。因此：
