...
└── modules/       ← 模块级文档模板（README.md、flow.md、data-model.md、api-reference.md、code-map.md、database/）
```
...
`skills/blyy-init-docs/resources/tech-stack-matrix.md` 中的「锚点文件矩阵」定义了各技术栈的关键文件识别规则（v0.3.3 起从 `doc-guide.md` 拆分出来）。
...
| `tech-stack-matrix.md` | Phase 0.3 / Phase 2 扫描前（清点命令、锚点、模块识别） |
...
| 自定义模块级 API 接口文档结构 | `skills/blyy-init-docs/templates/modules/api-reference.md.template` |
